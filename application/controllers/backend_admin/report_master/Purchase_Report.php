...
class Purchase_Report extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->controllerPath = 'backend_admin/report_master/Purchase_Report/';
        ...
        if (isset($_POST['submit'])) {
            ...
            if (!empty($from_date) || !empty($to_date) || !empty($member_name) || !empty($voucher_no)) {
                ...
                if (!empty($from_date) && $from_date !=  'dd-mm-yyyy') {
                    $filter_date = " AND PM.purchase_date = '$from_date'";
                };
                ...
                if (!empty($to_date) && $to_date !=  'dd-mm-yyyy') {
                    ...
                    if (!empty($from_date) && $from_date !=  'dd-mm-yyyy') {
                        $filter_date = " AND PM.purchase_date BETWEEN '$from_date' AND '$to_date'";
                    } else {
                        $filter_date = " AND PM.purchase_date = $to_date";
                    }
                }
