...
class Bank_Report extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->controllerPath = 'backend_admin/report_master/Bank_Report/';
        ...
        if (isset($_POST['submit'])) {
            ...
            if (!empty($from_date) || !empty($to_date) || !empty($member_name) || !empty($voucher_no)) {
                ...
                if (!empty($from_date) && $from_date !=  'dd-mm-yyyy') {
                    $filter_date = " AND BM.bank_date = '$from_date'";
                };
                ...
                if (!empty($to_date) && $to_date !=  'dd-mm-yyyy') {
                    ...
                    if (!empty($from_date) && $from_date !=  'dd-mm-yyyy') {
                        $filter_date = " AND BM.bank_date BETWEEN '$from_date' AND '$to_date'";
                    } else {
                        $filter_date = " AND BM.bank_date = $to_date";
                    }
                }
                ...
                if (!empty($voucher_no)) {
                    $voucher = " AND BM.voucher_no = $voucher_no";
                    // $member_id = " AND AM.account_no = $member_name";
                    // $mem_name = $this->db->get_where('account_master', array('account_no' => $member_name))->row();
