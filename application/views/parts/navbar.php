<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="#"><img src="<?= base_url() ?>assets/logo/<?= $company_data['logo']; ?>" class="mr-2" alt="logo" width="80px" /></a>
        <a class="navbar-brand brand-logo-mini" href="#"><img src="<?= base_url() ?>assets/logo/<?= $company_data['logo']; ?>" alt="logo" /></a>
    </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                    ...
                    <?php if (!empty($grp_data)) {
                        foreach ($grp_data as $noti) { ?>
                    ...
                    <?php if (!empty($vc_data)) {
                        foreach ($vc_data as $noti) { ?>
                    ...
                    <?php if (!empty($vc_draw_data)) {
                        foreach ($vc_draw_data as $noti) { ?>
                            <!-- <a class="dropdown-item preview-item" href="<?= base_url() ?>/backend_admin/vc_master/Vc_master/edit/<?= $noti['id']; ?>">
                        <div class="preview-thumbnail">
                            <div class="preview-icon bg-success">
                                <i class="ti-info-alt mx-0"></i>
