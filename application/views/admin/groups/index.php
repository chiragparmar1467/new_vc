                        ...
                        <table id="example1" class="table table-bordered table-hover table-striped">
                            <thead>
                                <tr class="text-center">
                                    <th>Sr. No.</th>
                                    <th>Group Start Name</th>
                                    <th>Group Closing Name</th>
                                    <th>Group Name</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php 
                                     $date = date("d-m-Y", strtotime($v['start_date'])); 
                                    echo $date; ?>
                                    </td>

                                    <td class="text-center">
                                        <?php 
                                         $date = date("d-m-Y", strtotime($v['end_date'])); 
                                         echo $date; ?>
                                    </td>

                                    <td class="text-center"><?php  echo  $v['name'];  ?>
                                    </td>
                                    <td class="text-center"><?php echo $v['short_name']; ?>
                                    </td>
