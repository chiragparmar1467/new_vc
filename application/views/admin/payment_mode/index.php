                        ...
                        <table id="example1" class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php  echo  $v['payment_mode'];  ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url() . $this->controllerPath ?>view/<?php echo $v['id'];  ?>"
                                            title="View" class="btn btn-primary p-2"><i class="fa fa-eye"></i></a>
