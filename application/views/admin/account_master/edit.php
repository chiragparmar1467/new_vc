                  ...
                  <div class="card card-primary">
                      ...
                      <form role="form"
                          ...
                          <div class="card-body row">
                              ...
                              <div class="form-group col-md-6">
                                  <label for="member">Select Member Name</label>
                                  <select class="js-example-basic-single w-100" id="member_name" name="member_name"
                                      required>
                                      <option value="" disabled selected hidden>Select Member Name</option>
                                      <?php  $q = $this->db->get_where('member_master',array('deleted'=>'0','status'=>'1'));
                                      foreach ($q->result_array() as $k => $v): ?>
                                      <option value="<?php echo $v['id'] ?>"
                                          <?php if($edit_data['fk_member_id'] == $v['id']) { echo 'selected'; } ?>>
                              ...
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="text" class="form-control " id="opening_balance" name="opening_balance"
                                      value="<?= $edit_data['opening_balance']; ?>" placeholder="Enter Opening Balance" autocomplete="off">
                              </div>
