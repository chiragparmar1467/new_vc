                ...
                <form role="form"
                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="js-example-basic-single w-100" id="member_name" name="member_name" required>
                                ...
                                <option value="<?php echo $v['id'] ?>"><?php echo $v['member_name'] ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control " id="opening_balance" name="opening_balance" value="0"
