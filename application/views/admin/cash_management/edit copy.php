          ...
          <div class="row">
              <div class="col-md-12 col-xs-12">
                  ...
                  <div class="card card-primary">
                      ...
                      <form role="form"
                          action="<?php echo base_url() . $this->controllerPath ?>edit/<?php echo $edit_data['account_no']; ?>"
                          method="post">
                          <div class="card-body row">
                              ...
                              <div class="form-group col-md-6">
                                  ...
                                  <select class="form-control select2bs4" id="category_name" name="category_name" required onchange="cat()">
                              ...
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="text" class="form-control" id="enter_loan_amount"
                                      name="enter_loan_amount" value="<?= $edit_data['loan_amount'] ?>" placeholder="Enter Loan Amount"
                                      autocomplete="off" onkeyup="totalamount()">
                              </div>


                              <div class="form-group col-md-6">
                                  <label for="interest_amount">Enter Interest Amount</label>
                                  <input type="text" class="form-control" id="interest_amount" name="interest_amount"
                                      value="<?= $edit_data['interest_amount'] ?>" placeholder="Enter Interest Amount" autocomplete="off"
                                      onkeyup="totalamount()">
                              </div>
                              ...
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="text" class="form-control" id="month" name="month" value="<?= $edit_data['month'] ?>"
                                      placeholder="Enter Amount" autocomplete="off" onkeyup="totalamount()">
                              </div>
