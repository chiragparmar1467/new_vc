            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table>
                        ...
                        <tr>
                            <td style="font-weight: bold;">Loan Name</td>
                            <td><?= $view_data->name; ?></td>
                        </tr>
                        <tr>
                            <td style="font-weight: bold;">Loan Opening Date</td>
                            <td><?= date("d-m-Y", strtotime($view_data->vc_opening_date)); ?></td>
                        </tr>
                        <tr>
                            <td style="font-weight: bold;">Loan Closing Date</td>
                            <td><?= date("d-m-Y", strtotime($view_data->vc_closing_date)); ?></td>
                        </tr>
                        ...
                        <tr>
                          ...
                          $member = $this->db->get_where('member_master',array('id'=>$member_data['fk_member_id']))->row();
                             echo $i.') '.$member->member_name.'(Acc No :- '.$member_data['fk_account_id'].')<br>'; 
                             $i++; } ?></td>
                        </tr>
