                      ...
                      <div class="card-body row">
                          ...
                          <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control" name="vc_opening_date" id="datepicker"
                                  value="<?= date("d-m-Y", strtotime($edit_data['vc_opening_date'])) ?>" autocomplete="off" required>
                          </div>
                          ...
                          <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control" name="vc_closing_date" id="datepicker1"
                                  value="<?= date("d-m-Y", strtotime($edit_data['vc_closing_date'])) ?>" autocomplete="off" required>
                          </div>
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <select class="js-example-basic-single w-100" name="month" id="month">
                                ...
                                <?php
                                  ...
                                  <option value="<?= $row['month_code'] ?>" <?php if($edit_data['fk_month_code'] == $row['month_code']){ echo "selected";} ?> >
                                      <?= $row['month_shortname'] ?>
                                  </option>
                                  <?php } ?>
                            </select>
                          ...
                          <div class="form-group col-md-6">
                              ...
                              <input type="text" class="form-control" id="minimum" name="minimum" value="<?= $edit_data['minimum_amount'] ?>"
                                  placeholder="Enter Amount">
                          </div>

                          <div class="form-group col-md-6">
                              <label for="vc_name">Maximum</label>
                              <input type="text" class="form-control" id="maximum" name="maximum" value="<?= $edit_data['maximum_amount'] ?>"
                                  placeholder="Enter Amount">
                          </div>

                          <div class="form-group col-md-6">
                              <label for="vc_name">Instalment</label>
                              <input type="text" class="form-control" id="instalment" name="instalment" value="<?= $edit_data['instalment'] ?>"
                                  placeholder="Enter Amount">
                          </div>
                          ...
                          <div class="form-group col-md-6">
                              ...
                              value="<?php if($edit_data['vc_draw_date'] != 0000-00-00){ echo date("d-m-Y", strtotime($edit_data['vc_draw_date'])); } ?>"
                                  autocomplete="off" placeholder="Enter VC Draw Date">
                          </div>

                          <div class="form-group col-md-6">
                              <label for="vc_name">Loan Name</label>
                              <input type="text" class="form-control" id="vc_name" name="vc_name"
                                  value="<?= $edit_data['name'] ?>" placeholder="Enter Name">
                          </div>
                          ...
                          <div class="form-group col-md-6">
                              ...
                              <select class="js-example-basic-single w-100" name="group" id="group">
                                  ...
                                  <option value="<?= $row['id'] ?>"
                                      <?php if($edit_data['group_id'] == $row['id']){echo "selected"; }?>>
                                      <?= $row['name'] ?>
                                  </option>
                                  <?php } ?>
                              </select>
