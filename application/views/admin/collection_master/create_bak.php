                ...
                <form role="form" action="#" method="post"
                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="js-example-basic-single w-100" name="type_of_collection" id="type_of_collection" onchange = "get_fields()">
                        ...
                        <div class="form-group col-md-6" id="type_div">
                            <label>Select Type</label>
                        ...
                        <div class="form-group col-md-6 vc_month" >
                            ...
                            <option selected disabled hidden>Select Month</option>  
                                ...
                                <option value="<?php echo $v['month_code'] ?>" >
                        ...
                        <div class="form-group col-md-6" id="vc_grp">
                            ...
                            <option selected disabled hidden>Select Group</option>
                                <?php $q = $this->db->get_where('group_master',array('status' =>1,'deleted' =>0)); foreach ($q->result_array() as $k => $v): ?>
                        ...
                        <div class="form-group col-md-6" id="vc_div">
                            <label>Select Loan </label>
                            <select class="js-example-basic-single w-100" name="vc_name" id="vc_name" >
                                <option selected disabled hidden>Select VC</option>
                                <?php $q = $this->db->get_where('vc_master',array('deleted'=>'0','status'=>'1'));foreach ($q->result_array() as $k => $v): ?>
                                <option value="<?php echo $v['id'] ?>" >
                                    <?php echo $v['name'] ?></option>
                                <?php endforeach ?>
                            </select>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <option disabled selected hidden>Select Members</option>
                                  <?php
                                      ...
                                      WHERE mem.status = 1 AND mem.deleted= 0 AND map.status = 1 AND map.deleted = 0')->result_array();
...
function get_fields() {
   var type = document.getElementById("type_of_collection").value;
   ...
   if(type == 1){
       ...
       $("#vc_div").show();
       $("#type_div").hide();
       $('#myForm').attr('action', '<?php echo base_url() . $this->controllerPath ?>create');
  }
  ...
  if(type == 2){
      ...
      $("#vc_grp").hide();
      $("#vc_div").hide();
      $('#myForm').attr('action', '<?php echo base_url() . $this->CreditDebitControllerPath ?>create');
    }
