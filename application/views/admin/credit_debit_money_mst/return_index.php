                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><?php 
                                            $acc_opening_date = date("d-m-Y", strtotime($v['acc_opening_date']));  
                                        echo  $acc_opening_date; ?>
                                        </td>
                                        <td class="text-center"><?php 
                                            $acc_closing_date = date("d-m-Y", strtotime($v['acc_closing_date']));  
                                        ...
                                        <!-- <td class="text-center"><?php
                                         $part_master =$this->db->get_where("loan_party_master",array('id' => $v['fk_party_id']))->row();
                                         echo  $part_master->mobile_number; ?>
                                        </td> -->

                                        <td class="text-center">
                                            <?php echo $v['loan_amount']; ?>
                                        </td>
                                        <td class="text-center">
                                            <?php echo $v['interest_amount']; ?>
                                        </td>
                                        <td class="text-center">
                                            <?php echo $v['month']; ?>
                                        </td>
                                        <td class="text-center">
                                            <p><?php if($loan_master['fk_loan_category_id'] == 2)  { echo $v['loan_amount']; } 
                                        else{
                                            echo $v['final_amount'];
                                        }    ?>
                                            </p>
