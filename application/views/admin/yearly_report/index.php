                    ...
                    <form role="form" action="<?php echo base_url() . $this->controllerPath ?>create" method="post"
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group col-md-3">
                                <label for="account_name">Select Year</label>
                                <select class="js-example-basic-single w-100" name="year" id="year"
                                    onchange="get_vc()">
                                    <option selected disabled hidden>Select Year</option>
                                    <?php $q = $this->db->get_where('financial_year_master',array('deleted' =>0)); foreach ($q->result_array() as $k => $v): ?>
...
$(document).ready(function() {
    $("#li-yearly-report").addClass('active');
    $("#link-yerly-report").addClass('active');
