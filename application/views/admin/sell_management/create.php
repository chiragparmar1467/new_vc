                    ...
                    <div class="field_wrapper1">
                        <div class="card-body row">
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control voucher_no" id="voucher_no" name="voucher_no[]" value="<?php echo $this->data['voucher_no'] + 1;  ?>" placeholder="Enter Voucher Number" required>
    ...
    function voucher_no() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('input[name="transaction[]"][value="' + data.transaction + '"]').prop('checked', true); // Check the appropriate radio button
            },
